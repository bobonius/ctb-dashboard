...
const bold = () => document.documentElement.dataset.skin === 'bold';
  ...
  $('#app').innerHTML = `<div class="wrap">
    <header class="mast">
      ...
      <div class="skin" role="group" aria-label="Page style">
        <button type="button" data-skin="" aria-pressed="${!bold()}">Classic</button>
        <button type="button" data-skin="bold" aria-pressed="${bold()}">Bold</button>
      </div>
    </header>
    ${hero(next)}
    <div class="grid">
