...
function matchPanel(f) {
  ...
  const star = L.isPlayed(f) && state.motm.get(f.id);
  if (star) run.push(`<div class="strip"><span class="lbl">Man of the match</span>
    <span class="sub motm">${mug(star, 'fc')}${esc(playerName(star))}</span></div>`);
